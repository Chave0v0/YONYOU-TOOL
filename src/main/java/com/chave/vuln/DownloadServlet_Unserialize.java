...
public class DownloadServlet_Unserialize extends VulnBase {
    ...
    public DownloadServlet_Unserialize() {
    }

    public DownloadServlet_Unserialize(TextArea log, TextArea uploadLog, TextArea execLog) {
