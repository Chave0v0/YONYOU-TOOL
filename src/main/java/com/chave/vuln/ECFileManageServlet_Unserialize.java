...
public class ECFileManageServlet_Unserialize extends VulnBase {
    ...
    public ECFileManageServlet_Unserialize() {
    }

    public ECFileManageServlet_Unserialize(TextArea log, TextArea uploadLog, TextArea execLog) {
