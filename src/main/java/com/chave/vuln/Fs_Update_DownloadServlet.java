...
public class Fs_Update_DownloadServlet extends VulnBase {
    ...
    public Fs_Update_DownloadServlet() {
    }

    public Fs_Update_DownloadServlet(TextArea log, TextArea uploadLog, TextArea execLog) {
